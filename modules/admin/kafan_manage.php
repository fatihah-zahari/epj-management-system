...
$stmt = $pdo->prepare("
  SELECT k.id, u.fullname AS waris, k.deceased_name, k.status, k.created_at, k.document_path
  FROM kafan_requests k
  JOIN users u ON u.id=k.user_id
  $whereSQL
...
$pageTitle = "Admin - Manage Kafan";
require __DIR__ . '/../../app/views/header.php';
?>

<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0">Manage Kafan</h4>
                        ...
                        <td>
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a class="btn btn-sm btn-outline-primary"
                                    href="/epj/modules/imam/request_details.php?type=kafan&id=<?= (int)$r['id'] ?>">
                                    Details
                                </a>

                                <?php if (!empty($r['document_path'])): ?>
                                    <a class="btn btn-sm btn-outline-dark"
                                        href="/epj/public/file.php?type=kafan&id=<?= (int)$r['id'] ?>">
                                        Doc
                                    </a>
                                <?php endif; ?>
